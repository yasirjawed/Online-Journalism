        ...
        <div class="row">
            @for ($i = 0; $i < 6; $i++)
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mt-5">
                    <div class="card">
                        <img class="card-img-top" src="{{url('images/sanity.jpg')}}" alt="Card image cap">
                        <h5 class="card-title" style="background-color:black;height:auto;text-align:center;font-size:30px;color:white;font-family: 'Montserrat', sans-serif;">Sanity</h5>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    <p class="no-stories"><i>14 stories</i></p>
                                </div>
                                <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                                <p class="corres-names" style="color: red">Nabeetah Shabbir And Patrich Chalmers</p>
                                </div>
                            </div>
                        </div>
                    </div>
